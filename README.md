...
A somewhat trivial example is a [traffic light](/armin-reichert/statemachine-samples/TrafficLight/de/amr/statemachine/samples/trafficlight/TrafficLight.java) controlled using timers.
